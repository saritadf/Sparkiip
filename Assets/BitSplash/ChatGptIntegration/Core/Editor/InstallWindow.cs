    ...
    public class InstallWindow : EditorWindow
    {
        ...
        void Load()
        {
                ...
                !String.IsNullOrEmpty(mAuthSettings.PrivateApiKey))
            {
                ...
                mFileData.api_project_id = mAuthSettings.ProjectId;
                Save();
                return;
            }
            try
        ...
        {         
            ...
            mFileData.api_project_id = EditorGUILayout.TextField("Project Id", mFileData.api_project_id);
            ...
            if (File.Exists(authFilePath))
            {
                ...
                if (GUILayout.Button("Write Resource File"))
                {
                    if (Selected == 1) // server
                    {
                        ...
                        mAuthSettings.ProjectId = mFileData.api_project_id;
